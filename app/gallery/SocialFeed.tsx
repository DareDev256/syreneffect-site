        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-5 py-2.5 rounded-full text-sm font-medium tracking-wider uppercase transition-all ${
              activeTab === tab.id
                ? "bg-gradient-to-r from-purple-glow to-teal-glow text-white shadow-[0_0_20px_rgba(124,58,237,0.2)]"
...
function SectionHeader({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <h2 className="font-[family-name:var(--font-playfair)] text-2xl font-bold text-soft-white">
        {title}
      </h2>
      {href && (
        <a
          ...
          className="ml-auto text-xs text-muted hover:text-soft-white transition-colors tracking-wider uppercase"
        >
          Follow
        </a>
      )}
